...
%type	<statement>
	...
	ShowStmt			"Show engines/databases/tables/user/columns/warnings/status/slave statement"
	Statement			"statement"
...
|	slave '(' Identifier ')'
	{
		$$ = &ast.TableOptimizerHint{HintName: model.NewCIStr($1), SlaveNodeName: model.NewCIStr($3)}
	}
