...
var (
	...
	ErrInvalidJSONText = terror.ClassJSON.New(mysql.ErrCodeInvalidJSONText, mysql.ErrName[mysql.ErrCodeInvalidJSONText])
	// ErrInvalidJSONPath means invalid JSON path.
	ErrInvalidJSONPath = terror.ClassJSON.New(mysql.ErrCodeInvalidJSONPath, mysql.ErrName[mysql.ErrCodeInvalidJSONPath])
	// ErrInvalidJSONData means invalid JSON data.
	ErrInvalidJSONData = terror.ClassJSON.New(mysql.ErrCodeInvalidJSONData, mysql.ErrName[mysql.ErrCodeInvalidJSONData])
	// ErrInvalidJSONPathWildcard means invalid JSON path that contain wildcard characters.
	ErrInvalidJSONPathWildcard = terror.ClassJSON.New(mysql.ErrCodeInvalidJSONPathWildcard, mysql.ErrName[mysql.ErrCodeInvalidJSONPathWildcard])
	// ErrInvalidJSONContainsPathType means invalid JSON contains path type.
	ErrInvalidJSONContainsPathType = terror.ClassJSON.New(mysql.ErrCodeInvalidJSONContainsPathType, mysql.ErrName[mysql.ErrCodeInvalidJSONContainsPathType])
	// ErrInvalidJSONPathArrayCell means invalid JSON path for an array cell.
	ErrInvalidJSONPathArrayCell = terror.ClassJSON.New(mysql.ErrCodeInvalidJSONPathArrayCell, mysql.ErrName[mysql.ErrCodeInvalidJSONPathArrayCell])
)

func init() {
	terror.ErrClassToMySQLCodes[terror.ClassJSON] = map[terror.ErrCode]uint16{
		mysql.ErrCodeInvalidJSONText:             mysql.ErrCodeInvalidJSONText,
		mysql.ErrCodeInvalidJSONPath:             mysql.ErrCodeInvalidJSONPath,
		mysql.ErrCodeInvalidJSONData:             mysql.ErrCodeInvalidJSONData,
		mysql.ErrCodeInvalidJSONPathWildcard:     mysql.ErrCodeInvalidJSONPathWildcard,
		mysql.ErrCodeInvalidJSONContainsPathType: mysql.ErrCodeInvalidJSONContainsPathType,
		mysql.ErrCodeInvalidJSONPathArrayCell:    mysql.ErrCodeInvalidJSONPathArrayCell,
	}
}
