...
import (
	...
	types "Garyen-go/tidb/parser/tidb-types"
	driver "Garyen-go/tidb/parser/tidb-types/parser_driver"
...
func (s *testParserSuite) TestBuiltin(c *C) {
	table := []testCase{
		...
		{"SELECT CRC32('baseMySQL');", true, "SELECT CRC32('baseMySQL')"},
...
// For issue #51
// See https://Garyen-go/tidb/parser/pull/51 for details
...
// See https://Garyen-go/tidb/parser/issue/94
...
// See https://Garyen-go/tidb/parser/issue/95
