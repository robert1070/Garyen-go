...
// Collations maps baseMySQL default collation ID to its name.
...
// CollationNames maps baseMySQL default collation name to its ID
...
var (
	...
	DefaultCollationID   uint8 = 83
)

// baseMySQL collation information.
const (
...
// RangeGraph defines valid unicode characters to use in column names. It strictly follows baseMySQL's definition.
// See #3994.
