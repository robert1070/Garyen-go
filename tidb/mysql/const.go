...
func newInvalidModeErr(s string) error {
	return NewErr(ErrCodeWrongValueForVar, "sql_mode", s)
}

const (
	MinProtocolVersion byte   = 10
	ServerVersion      string = "5.7.25-targaryen"
	ServerComment      string = "MySQL Community Server (WPT)"
)
...
// baseMySQL max type field length.
const (
...
// DefaultLengthOfMysqlTypes is the map for default physical length of baseMySQL data types.
...
// SQLMode is the type for baseMySQL sql_mode.
